...
function getTodayDateStr() { const d = new Date(); return `${d.getFullYear()}-${Strinconst firebaseConfig = { apiKey: "AIzaSyCxjdCTKHQlpm7SYbWCEws1HhcOaFp0LBA", authDomain: "cssd-system-2878c.firebaseapp.com", projectId: "cssd-system-2878c", storageBucket: "cssd-system-2878c.firebasestorage.app", messagingSenderId: "662377321937", appId: "1:662377321937:web:001c092e10319547623cf0" };
firebase.initializeApp(firebaseConfig); const db = firebase.firestore();
...
function renderTheoTabHienTai() {
    if(activeTab === 'khoaphong') {
        ...
        if(document.getElementById("bangLichSuHap")) {
            ...
            // --- ĐÃ TINH CHỈNH: Chỉ lấy các mẻ hấp phát sinh trong ngày hôm nay ---
...
function clearTruyVetBatch() { 
    ...
    callRender(); 
}g(d.getMonth()+1).padStart(2,'0')}-${String(d.getDate()).padStart(2,'0')}`; }
